      ...
      <el-scrollbar style="height: 100%" wrap-class="scrollbar-wrapper">
        <el-main>
          <el-row v-for="data in tableData" :key="data.id">
            <!--头像-->
            <el-col :span="5">
              <el-avatar v-if="data.authorProfile != null" :size="85" fit="contain"
                         :src="data.authorProfile"></el-avatar>
  ...
  data() {
    return {
      tableData: [
        {
          id: 2,
          authorProfile: "https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png",
          views: 2,
          title: 'hahaha',
          comment: 0
        }
