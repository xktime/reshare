    ...
    <el-container>
      ...
      <el-main>
        <el-table :data="tableData">
          <el-table-column prop="publishTime" label="日期" width="140"></el-table-column>
          <el-table-column prop="authorName" label="姓名" width="120"></el-table-column>
          <el-table-column prop="channelName" label="地址"></el-table-column>
        </el-table>
      </el-main>
    </el-container>
  </el-container>
