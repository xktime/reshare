...
CREATE TABLE `article` (
  ...
  `channel_id` int(10) unsigned DEFAULT '0' COMMENT '文章所属频道ID',
  ...
  `likes` int(5) unsigned DEFAULT '0' COMMENT '点赞数量',
  `collection` int(5) unsigned DEFAULT '0' COMMENT '收藏数量',
  `comment` int(5) unsigned DEFAULT '0' COMMENT '评论数量',
  `views` int(5) unsigned DEFAULT '0' COMMENT '阅读数量',
